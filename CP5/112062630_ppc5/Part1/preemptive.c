...
__data __at (0x20) char temp_SP;
__data __at (0x21) char temp;
__data __at (0x22) char sft;
...
void Bootstrap(void)
{
    ...
    IE = 0x82; // enable timer 0 interrupt; keep consumer polling EA - ET2 ES ET1 EX1 ET0 EX0
