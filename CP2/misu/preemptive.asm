...
;	preemptive.c:273: do
00109$:
;	preemptive.c:285: currID = ((currID >= 3)? 0 : (currID + 1));
	clr	c
	mov	a,_currID
	subb	a,#0x03
...
00115$:
	mov	_currID,r6
;	preemptive.c:286: switch (currID)
	mov	a,_currID
	mov	r7,a
	add	a,#0xff - 0x03
	jc	00106$
...
00134$:
	...
	sjmp	00104$
00101$:
;	preemptive.c:289: sft_temp = 1;
	mov	_sft_temp,#0x01
;	preemptive.c:290: break;
;	preemptive.c:291: case 1:
	sjmp	00106$
00102$:
;	preemptive.c:292: sft_temp = 2;
	mov	_sft_temp,#0x02
;	preemptive.c:293: break;
;	preemptive.c:294: case 2:
	sjmp	00106$
00103$:
;	preemptive.c:295: sft_temp = 4;
	mov	_sft_temp,#0x04
;	preemptive.c:296: break;
;	preemptive.c:297: case 3:
	sjmp	00106$
00104$:
;	preemptive.c:298: sft_temp = 8;
	mov	_sft_temp,#0x08
;	preemptive.c:303: }
00106$:
;	preemptive.c:304: if (bitmap & sft_temp){
	mov	a,_sft_temp
	anl	a,_bitmap
	jz	00109$
...
;	preemptive.c:329: RESTORESTATE;
	...
	POP B 
	POP ACC 
;	preemptive.c:330: EA = 1;
;	assignBit
	setb	_EA
;	preemptive.c:333: __endasm;
	RETI
;	preemptive.c:334: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	preemptive.c:341: void ThreadExit(void)
;	-----------------------------------------
;	 function ThreadExit
;	-----------------------------------------
_ThreadExit:
