      ...
      000000                        229 	.ds 8
                                    ...
                                    232 ;--------------------------------------------------------
                                    233 	.area DSEG    (DATA)
                           000032   234 _buff	=	0x0032
                           000033   235 _buff_full	=	0x0033
                           000034   236 _item	=	0x0034
                                    237 ;--------------------------------------------------------
      ...
      000017 75 34 41         [24]  343 	mov	_item,#0x41
                                    344 ;	testpreempt.c:40: while (buff_full){
      00001A                        345 00101$:
      00001A E5 33            [12]  346 	mov	a,_buff_full
      ...
      000025 85 34 32         [24]  354 	mov	_buff,_item
                                    355 ;	testpreempt.c:45: buff_full = 1;
      000028 75 33 01         [24]  356 	mov	_buff_full,#0x01
      ...
      000031 B5 34 03         [24]  361 	cjne	a,_item,00125$
      ...
      00003C AF 34            [24]  369 	mov	r7,_item
      ...
      00004B                        380 00110$:
      00004B 8E 34            [24]  381 	mov	_item,r6
      ...
      00005E                        408 00101$:
      00005E E5 33            [12]  409 	mov	a,_buff_full
      ...
      000069 85 32 99         [24]  417 	mov	_SBUF,_buff
      ...
      000099 22               [24]  486 	ret
                                    ...
                                    489 ;------------------------------------------------------------
                                    490 ;	testpreempt.c:138: void _mcs51_genXRAMCLEAR(void) {}
                                    491 ;	-----------------------------------------
      ...
      00009A 22               [24]  495 	ret
                                    ...
                                    498 ;------------------------------------------------------------
                                    499 ;	testpreempt.c:140: void timer0_ISR(void) __interrupt(1) {
                                    500 ;	-----------------------------------------
                                    501 ;	 function timer0_ISR
                                    502 ;	-----------------------------------------
      00009B                        503 _timer0_ISR:
                                    504 ;	testpreempt.c:143: __endasm;
      00009B 02 01 CA         [24]  505 	LJMP	_myTimer0Handler
                                    506 ;	testpreempt.c:144: }
