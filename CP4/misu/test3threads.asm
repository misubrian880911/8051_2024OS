...
;	test3threads.c:45: item1 = 'A';
	mov	_item1,#0x41
;	test3threads.c:48: while(turn != 1){}
00101$:
	mov	a,#0x01
	cjne	a,_turn,00101$
...
;------------------------------------------------------------
;	test3threads.c:71: void Producer2(void)
;	-----------------------------------------
;	 function Producer2
;	-----------------------------------------
_Producer2:
;	test3threads.c:79: item2 = '0';
	mov	_item2,#0x30
;	test3threads.c:82: while(turn != 2){}
00101$:
	mov	a,#0x02
	cjne	a,_turn,00101$
;	test3threads.c:86: SemaphoreWait(empty);
		2$:
;; top of while-loop 
	MOV A, _empty ;; read value of _S into ACC (where empty is semaphore) 
...
;; fall-through to drop out of while-loop 
	dec _empty 
;	test3threads.c:87: SemaphoreWait(mutex);
		3$:
;; top of while-loop 
	MOV A, _mutex ;; read value of _S into ACC (where mutex is semaphore) 
...
00125$:
;	test3threads.c:89: buff[tail] = item2;
	mov	a,_tail
	add	a,#_buff
	mov	r0,a
	mov	@r0,_item2
;	test3threads.c:90: tail = (tail + 1) % 3;
	mov	r6,_tail
	mov	r7,#0x00
	mov	dpl,r6
	mov	dph,r7
...
;	1-genFromRTrack replaced	mov	(__modsint_PARM_2 + 1),#0x00
	...
	mov	ea,c
;	test3threads.c:92: SemaphoreSignal(mutex);
	INC _mutex 
;	test3threads.c:93: SemaphoreSignal(full);
	INC _full 
;	test3threads.c:94: item2 = (item2 != '9')? (item2 + 1) : '0';
	mov	a,#0x39
	cjne	a,_item2,00126$
	setb	c
	sjmp	00127$
...
;------------------------------------------------------------
;	test3threads.c:109: void Consumer(void)
;	-----------------------------------------
;	 function Consumer
;	-----------------------------------------
_Consumer:
;	test3threads.c:115: EA = 0;
;	assignBit
	clr	_EA
;	test3threads.c:116: TMOD |= 0x20;
	orl	_TMOD,#0x20
;	test3threads.c:117: TH1 = (char)-6;
	mov	_TH1,#0xfa
;	test3threads.c:118: SCON = 0x50;
	mov	_SCON,#0x50
;	test3threads.c:119: TR1 = 1;
;	assignBit
	setb	_TR1
;	test3threads.c:120: EA = 1;
;	assignBit
	setb	_EA
;	test3threads.c:123: while (1)
00105$:
;	test3threads.c:137: SemaphoreWait(full);
		4$:
;; top of while-loop 
...
;; fall-through to drop out of while-loop 
	dec _full 
;	test3threads.c:138: SemaphoreWait(mutex);
		5$:
;; top of while-loop 
	MOV A, _mutex ;; read value of _S into ACC (where mutex is semaphore) 
...
00121$:
;	test3threads.c:140: SBUF = buff[head];
	mov	a,_head
	add	a,#_buff
	mov	r1,a
	mov	_SBUF,@r1
;	test3threads.c:141: head = (head + 1) % 3;
	mov	r6,_head
	mov	r7,#0x00
	mov	dpl,r6
	mov	dph,r7
...
;	1-genFromRTrack replaced	mov	(__modsint_PARM_2 + 1),#0x00
	...
	mov	ea,c
;	test3threads.c:144: SemaphoreSignal(mutex);
	INC _mutex 
;	test3threads.c:145: SemaphoreSignal(empty);
	INC _empty 
;	test3threads.c:147: while (!TI){
00101$:
;	test3threads.c:150: TI = 0;
;	assignBit
	jbc	_TI,00105$
;	test3threads.c:152: }
	sjmp	00101$
...
;------------------------------------------------------------
;	test3threads.c:159: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;	test3threads.c:165: turn = 1;
	mov	_turn,#0x01
;	test3threads.c:170: }
	...
	clr	_main_sloc0_1_0
00103$:
;	test3threads.c:167: SemaphoreCreate(empty, 3);
	mov	_empty,#0x03
;	test3threads.c:168: SemaphoreCreate(full, 0);
	mov	_full,#0x00
;	test3threads.c:169: SemaphoreCreate(mutex, 1);
	mov	_mutex,#0x01
	mov	c,_main_sloc0_1_0
	mov	ea,c
;	test3threads.c:177: ThreadCreate(Producer1);
	mov	dptr,#_Producer1
	lcall	_ThreadCreate
;	test3threads.c:178: ThreadCreate(Producer2);
	mov	dptr,#_Producer2
	lcall	_ThreadCreate
;	test3threads.c:179: Consumer();
;	test3threads.c:180: }
	ljmp	_Consumer
;------------------------------------------------------------
;Allocation info for local variables in function '_sdcc_gsinit_startup'
;------------------------------------------------------------
;	test3threads.c:182: void _sdcc_gsinit_startup(void)
;	-----------------------------------------
;	 function _sdcc_gsinit_startup
;	-----------------------------------------
__sdcc_gsinit_startup:
;	test3threads.c:186: __endasm;
	LJMP	_Bootstrap
;	test3threads.c:187: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	test3threads.c:189: void _mcs51_genRAMCLEAR(void) {
;	-----------------------------------------
...
;------------------------------------------------------------
;	test3threads.c:192: void _mcs51_genXINIT(void) {}
;	-----------------------------------------
...
;------------------------------------------------------------
;	test3threads.c:193: void _mcs51_genXRAMCLEAR(void) {}
;	-----------------------------------------
...
;------------------------------------------------------------
;	test3threads.c:195: void timer0_ISR(void) __interrupt(1) {
;	-----------------------------------------
;	 function timer0_ISR
;	-----------------------------------------
_timer0_ISR:
;	test3threads.c:198: __endasm;
